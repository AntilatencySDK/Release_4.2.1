...
namespace AndroidJniWrapper {
	...
	Antilatency::InterfaceContract::ExceptionCode initJni(void* vm, void* context) {
	...
	*/
	struct IAndroidJni : Antilatency::InterfaceContract::IInterface {
		...
		Antilatency::InterfaceContract::ExceptionCode initJni(void* vm, void* context) {
			return (reinterpret_cast<VMT*>(this->_object))->initJni(vm, context);
		}
	};
} //namespace AndroidJniWrapper
		...
		namespace Details {
			...
			public:
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL initJni(void* vm, void* context) {
					auto exceptionCode_ = this->_object->initJni(vm, context);
