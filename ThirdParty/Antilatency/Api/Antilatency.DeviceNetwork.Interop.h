...
namespace Antilatency {
	namespace DeviceNetwork {
		namespace Interop {
			...
			Antilatency::InterfaceContract::ExceptionCode packet(Antilatency::DeviceNetwork::Interop::Packet packet) {
			...
			*/
			struct IDataReceiver : Antilatency::InterfaceContract::IInterface {
				...
				Antilatency::InterfaceContract::ExceptionCode packet(Antilatency::DeviceNetwork::Interop::Packet packet) {
					return (reinterpret_cast<VMT*>(this->_object))->packet(packet);
				}
			};
		} //namespace Interop
	} //namespace DeviceNetwork
		...
		namespace Details {
			...
			public:
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL packet(Antilatency::DeviceNetwork::Interop::Packet packet) {
					auto exceptionCode_ = this->_object->packet(packet);
