...
Git command to clone this subset: `git clone --branch subset-e2de67044f1dc7ddf528b7d9b03f5ef0e7aa11ae --single-branch https://github.com/AntilatencySDK/Release_4.2.1.git AntilatencySDK`
