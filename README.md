# Antilatency SDK 4.2.1

Git command to clone this subset: `git clone --branch subset-87675f9400379a98714d9d4e33f609546960ba4b --single-branch https://github.com/AntilatencySDK/Release_4.2.1.git`
