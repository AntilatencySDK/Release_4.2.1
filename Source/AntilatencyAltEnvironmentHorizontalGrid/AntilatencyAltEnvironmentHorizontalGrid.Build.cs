...
namespace UnrealBuildTool.Rules {
    public class AntilatencyAltEnvironmentHorizontalGrid : ModuleRules {

        public AntilatencyAltEnvironmentHorizontalGrid(ReadOnlyTargetRules Target) : base(Target) {
            ...
            if (Target.Platform == UnrealTargetPlatform.Win32 || Target.Platform == UnrealTargetPlatform.Win64) {
                ...
                var aplPath = Path.Combine(pluginPath, "AntilatencyAltEnvironmentHorizontalGrid_APL.xml");
#if UE_4_19_OR_LATER
