...
namespace UnrealBuildTool.Rules {
    public class AntilatencyAltEnvironmentPillars : ModuleRules {

        public AntilatencyAltEnvironmentPillars(ReadOnlyTargetRules Target) : base(Target) {
            ...
            if (Target.Platform == UnrealTargetPlatform.Win32 || Target.Platform == UnrealTargetPlatform.Win64) {
                ...
                var aplPath = Path.Combine(pluginPath, "AntilatencyAltEnvironmentPillars_APL.xml");
#if UE_4_19_OR_LATER
