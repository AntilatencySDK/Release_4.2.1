...
namespace UnrealBuildTool.Rules {
    public class AntilatencyAltEnvironmentArbitrary2D : ModuleRules {

        public AntilatencyAltEnvironmentArbitrary2D(ReadOnlyTargetRules Target) : base(Target) {
            ...
            if (Target.Platform == UnrealTargetPlatform.Win32 || Target.Platform == UnrealTargetPlatform.Win64) {
                ...
                var aplPath = Path.Combine(pluginPath, "AntilatencyAltEnvironmentArbitrary2D_APL.xml");
#if UE_4_19_OR_LATER
