...
namespace Antilatency.TrackingAlignment {
	namespace Details {
		...
		public class ITrackingAlignmentRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode update(System.IntPtr _this, UnityEngine.Quaternion a, UnityEngine.Quaternion b, float time, out Antilatency.TrackingAlignment.State result) {
				try {
...
namespace Antilatency.TrackingAlignment {
	...
	namespace Details {
		...
		public class ILibraryRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode createTrackingAlignment(System.IntPtr _this, UnityEngine.Quaternion initialARelativeToB, float initialTimeBAheadOfA, out System.IntPtr result) {
				try {
