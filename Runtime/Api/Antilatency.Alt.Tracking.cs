...
namespace Antilatency.Alt.Tracking {
	namespace Details {
		...
		public class ITrackingCotaskRemap : Antilatency.DeviceNetwork.Details.ICotaskRemap {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getExtrapolatedState(System.IntPtr _this, UnityEngine.Pose placement, float deltaTime, out Antilatency.Alt.Tracking.State result) {
				try {
...
namespace Antilatency.Alt.Tracking {
	namespace Details {
		...
		public class ITrackingDataCotaskRemap : Antilatency.DeviceNetwork.Details.ICotaskRemap {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getOpticsToBodyRotation(System.IntPtr _this, out UnityEngine.Quaternion result) {
				try {
...
namespace Antilatency.Alt.Tracking {
	...
	namespace Details {
		...
		public class ILibraryRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode createPlacement(System.IntPtr _this, Antilatency.InterfaceContract.Details.ArrayInMarshaler.Intermediate code, out UnityEngine.Pose result) {
				try {
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode encodePlacement(System.IntPtr _this, UnityEngine.Vector3 position, UnityEngine.Vector3 rotation, Antilatency.InterfaceContract.Details.ArrayOutMarshaler.Intermediate result) {
				try {
					var obj = GetContext(_this) as ILibrary;
